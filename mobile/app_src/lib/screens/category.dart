...
class _CategoryScreenState extends State<CategoryScreen> {
            ...
            Expanded(
              child: FutureBuilder<List<Product>>(
                ...
                builder: (context, snap) {
                  ...
                  if (_all.isEmpty) return const EmptyState('Bu kateqoriyada məhsul yoxdur');
                  return Column(
                    children: [
  ...
  Widget _list() {
    ...
    if (items.isEmpty) {
      return const EmptyState('Bu filtrlərə uyğun məhsul tapılmadı');
    }
