...
class _FilterSheetState extends State<_FilterSheet> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text('Filtr', style: sg(size: 20, weight: FontWeight.w600, spacing: -.3)),
                GestureDetector(
                  onTap: _reset,
                  child: Text('Sıfırla', style: mr(size: 13.5, weight: FontWeight.w700, color: C.muted2)),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Text('$count nəticəni göstər',
  ...
  Widget _label(String t) => Padding(
        ...
        child: Text(t, style: mr(size: 13, weight: FontWeight.w800)),
      );
