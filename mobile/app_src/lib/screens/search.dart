...
class _SearchScreenState extends State<SearchScreen> {
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Axtarış', style: sg(size: 26, weight: FontWeight.w600, spacing: -.4)),
          ),
          _searchField(),
  ...
  Widget _content() {
    ...
    if (_results.isEmpty) {
      return EmptyState('«${_query.trim()}» üçün nəticə tapılmadı');
    }
    return ListView(
      ...
      children: [
        Padding(
          ...
          child: Text('NƏTİCƏLƏR · ${_results.length}',
  ...
  Widget _recent() {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        if (recent.isEmpty) {
          return const EmptyState('Məhsul adı və ya markanı yazıb axtar');
        }
        return ListView(
                ...
                for (final t in recent)
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(t, style: mr(size: 13, weight: FontWeight.w600, color: C.muted2)),
                    ),
                  ),
              ],
            ),
