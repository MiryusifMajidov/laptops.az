        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              // Mərkəzdə AI "Söhbət" — prominent (dizayn: lacivərd kvadrat + mavi ulduz)
              GestureDetector(
                  ...
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.auto_awesome,
                          color: Color(0xFF4C86FF), size: 23),
                    ),
                    const SizedBox(height: 5),
                    Text('Söhbət',
                        style: mr(size: 10, weight: FontWeight.w700, color: C.ink)),
                  ],
                ),
              ),
              _NavItem(
