...
const Map<String, Map<String, String>> _s = {
  ...
  'profile.deleteAccount': {'az': 'Hesabı sil', 'ru': 'Удалить аккаунт', 'tr': 'Hesabı sil', 'en': 'Delete account'},
  'profile.deleteHint': {'az': 'Hesabınız və məlumatlarınız həmişəlik silinir.', 'ru': 'Ваш аккаунт и данные будут удалены навсегда.', 'tr': 'Hesabınız ve verileriniz kalıcı olarak silinir.', 'en': 'Your account and data are permanently deleted.'},
  'profile.deleteTitle': {'az': 'Hesabı silmək istəyirsiniz?', 'ru': 'Удалить аккаунт?', 'tr': 'Hesabı silmek istiyor musunuz?', 'en': 'Delete your account?'},
  'profile.deleteBody': {'az': 'Hesabınız, giriş məlumatlarınız və tərəfdaşlıq müraciətiniz həmişəlik silinəcək. Bu əməliyyat geri qaytarıla bilməz.', 'ru': 'Ваш аккаунт, данные для входа и заявка на партнёрство будут удалены навсегда. Это действие необратимо.', 'tr': 'Hesabınız, giriş bilgileriniz ve ortaklık başvurunuz kalıcı olarak silinecek. Bu işlem geri alınamaz.', 'en': 'Your account, login details and partnership application will be permanently deleted. This cannot be undone.'},
  'profile.deleteConfirm': {'az': 'Bəli, sil', 'ru': 'Да, удалить', 'tr': 'Evet, sil', 'en': 'Yes, delete'},
  'profile.cancel': {'az': 'Ləğv et', 'ru': 'Отмена', 'tr': 'İptal', 'en': 'Cancel'},
  'profile.deleted': {'az': 'Hesabınız silindi', 'ru': 'Аккаунт удалён', 'tr': 'Hesabınız silindi', 'en': 'Your account has been deleted'},
