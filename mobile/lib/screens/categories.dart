      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(t('cat.title'), style: sg(size: 26, weight: FontWeight.w600, spacing: -.4)),
          ),
          Expanded(
            child: FutureBuilder<List<CatCount>>(
              ...
              builder: (context, snap) {
                ...
                if (cats.isEmpty) return EmptyState(t('cat.empty'));
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(t('cat.count').replaceAll('{n}', '${c.count}'),
