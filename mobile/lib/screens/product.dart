    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${t('product.call')}: $kStorePhone')),
        );
      }
    }
  }
      ...
      child: Row(
        ...
        children: [
          ...
          RoundIconButton(
            ...
            onTap: _p == null ? () {} : () => showShareSheet(context, _p!),
          ),
        ],
      ),
    );
          ...
          child: ListView(
            ...
            children: [
                ...
                child: SizedBox(
                  ...
                  child: imgs.isEmpty
                      ...
                      : PageView.builder(
                          ...
                          itemBuilder: (_, i) => NetImage(imgs[i], width: 900),
                        ),
                ),
              ),
              if (imgs.length > 1) ...[
              ...
              if (p.serial.isNotEmpty) ...[
                const SizedBox(height: 14),
                Text(t('product.serial').replaceAll('{s}', p.serial),
        ...
        for (final s in specs)
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(tt(s.attribute).toUpperCase(),
                    maxLines: 1,
