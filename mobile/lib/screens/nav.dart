...
/// Birbaşa sifariş formasını aç (kart / hero «Sifariş et» düyməsi üçün).
void openOrder(BuildContext context, Product product) {
  Navigator.of(context).push(MaterialPageRoute(
    builder: (_) => OrderFormScreen(product: product),
  ));
}

/// Bildirişlər ekranına keç.
void openNotifications(BuildContext context) {
  Navigator.of(context).push(MaterialPageRoute(builder: (_) => const NotificationsScreen()));
}

/// Profil / tərəfdaşlıq ekranına keç.
