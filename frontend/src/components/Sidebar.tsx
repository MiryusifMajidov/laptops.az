...
export type View =
  | 'dashboard' | 'satislar' | 'stok' | 'onlayn'
  | 'kredit' | 'kassa' | 'xercler'
  | 'musteriler' | 'filiallar' | 'realizasiya' | 'techizat' | 'kateqoriya'
  | 'partnyor' | 'hesabatlar' | 'kalkulyator' | 'mail' | 'sayt' | 'aisohbet' | 'ziyaretchi' | 'audit' | 'ayarlar'
...
export const NAV: NavGroup[] = [
  ...
  { label: 'BAZA', items: [
    ...
    { view: 'partnyor', label: 'Tərəfdaşlıq', adminOnly: true, icon: <svg viewBox="0 0 24 24" {...s}><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></svg> },
  ]},
  { label: 'HESABAT & SİSTEM', items: [
    ...
    { view: 'sayt', label: 'Sayt Tənzimləmələri', adminOnly: true, icon: <svg viewBox="0 0 24 24" {...s}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18" /></svg> },
    { view: 'aisohbet', label: 'AI söhbətləri', adminOnly: true, icon: <svg viewBox="0 0 24 24" {...s}><path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 8.5 8.5 0 0 1-3.8-.9L3 21l1.9-5.7a8.5 8.5 0 0 1-.9-3.8A8.38 8.38 0 0 1 12.5 3 8.38 8.38 0 0 1 21 11.5z" /><path d="M8.5 11.5h.01M12 11.5h.01M15.5 11.5h.01" /></svg> },
    { view: 'ziyaretchi', label: 'Ziyarətçilər', adminOnly: true, icon: <svg viewBox="0 0 24 24" {...s}><circle cx="12" cy="12" r="9" /><path d="M3 12h18M12 3a15 15 0 0 1 0 18M12 3a15 15 0 0 0 0 18" /><path d="M9 8l3-2 3 2" /></svg> },
